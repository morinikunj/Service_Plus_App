...
class AppTextTheme {
  ...
  static final textLightTheme = ThemeData.light().textTheme.copyWith(
     ...
     headlineLarge: ThemeData.light().textTheme.copyWith().headlineLarge!.copyWith(
      fontSize: GeneralSize.textsize1,
      fontWeight: GeneralSize.boldfont
    ),
    headlineMedium: ThemeData.light().textTheme.copyWith().headlineMedium!.copyWith(
      fontSize: GeneralSize.textsize2,
      fontWeight: GeneralSize.boldfont
    ),
    headlineSmall: ThemeData.light().textTheme.copyWith().headlineSmall!.copyWith(
    ...
    titleMedium: ThemeData.light().textTheme.copyWith().titleMedium!.copyWith(
    ...
    displaySmall: ThemeData.light().textTheme.copyWith().displaySmall!.copyWith(
      fontSize: GeneralSize.textsize7,
      fontWeight: GeneralSize.regularfont
    ),
  );
